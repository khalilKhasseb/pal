@php 
 $bg = filled($settings->subscription_background) && \Storage::disk('public')->exists($settings->subscription_background) ? '/'.$settings->subscription_background : config('theme.newsletter.bg');
@endphp
