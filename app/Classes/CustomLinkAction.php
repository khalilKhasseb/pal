        ...
        $this
                ...
                Grid::make(['md' => 3])
                    ->schema([
                        ...
                        Toggle::make('as_button')
                            ...
                            // ->dehydrated(function(Toggle $component) {
                        ...
                        Radio::make('button_size')
                        // ->label(trans('filament.tiptap-editor.buttons.button_size'))
                        ->columns(2)
                        ->visible(fn ($get) => $get('as_button'))
                        ->options([
                            'full_width' => trans('filament.tiptap-editor.buttons.full_width'),
                            'default' => trans('filament.tiptap-editor.buttons.default'),
                        ]),
            ...
            ->action(function (TiptapEditor $component, $data, $arguments) {
                ...
                $component->getLivewire()->dispatch(
                    ...
                    button_size: $data['as_button'] ? $data['button_size'] : '',
